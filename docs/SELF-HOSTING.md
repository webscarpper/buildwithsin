# GOATA Self-Hosting Guide

This guide provides detailed instructions for setting up and hosting your own instance of GOATA, an open-source generalist AI agent.
...
- Start GOATA using your preferred method
...
GOATA can be started in two ways:
...
For further assistance, join the [GOATA Discord Community](https://discord.gg/Py6pCBUUPw) or check the [GitHub repository](https://github.com/GOATA-ai/GOATA) for updates and issues.
