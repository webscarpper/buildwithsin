...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | BuildWithSin',
    description: 'Replay this Agent conversation on BuildWithSin',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | BuildWithSin';
    const description =
      projectData.description ||
      'Replay this Agent conversation on BuildWithSin';
