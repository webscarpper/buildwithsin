...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | GOATA',
    description: 'Replay this Agent conversation on GOATA',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | GOATA';
    const description =
      projectData.description ||
      'Replay this Agent conversation on GOATA';
